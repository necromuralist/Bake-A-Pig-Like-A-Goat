...
BLOG_TITLE = "Bake a Pig Like a Goat"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://necromuralist.github.io/Bake-A-Pig-Like-A-Goat/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://necromuralist.github.io/"
BLOG_EMAIL = "necromuralist@protonmail.com"
BLOG_DESCRIPTION = "Behavior Driven Development with Flask."  # (translatable)
